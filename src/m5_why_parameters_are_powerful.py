...
def main():
    ...
    #better_draw_circles(3,rg.Point(100,50))
    #better_draw_circles(20,rg.Point(-200,0))

    #even_better_draw_circles(rg.Point(100,-100),3,30,'green',2) #(point,radii,number,color,thick)
    #even_better_draw_circles(rg.Point(-200,0),13,7,'red',5)


    even_better_draw_circles(rg.Point(100, 0), 7, 10, 'green', 2)
    even_better_draw_circles(rg.Point(100, 0), 8, 9, 'red', 2)
    even_better_draw_circles(rg.Point(100, 0), 9, 8, 'blue', 2)
    even_better_draw_circles(rg.Point(100, 0), 10, 7, 'yellow', 2)

    even_better_draw_circles(rg.Point(200, 200), 10, 16, 'green', 1)
    even_better_draw_circles(rg.Point(200, -200), 20, 15, 'red', 2)
    even_better_draw_circles(rg.Point(-200, 200), 30, 14, 'blue', 3)
    even_better_draw_circles(rg.Point(-200, -200), 40, 13, 'yellow', 4)
...
def better_draw_circles(radii,point):
    """
...
def even_better_draw_circles(point,radii,number,color,thick):
