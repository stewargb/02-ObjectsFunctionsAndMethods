...
def try_methods():
    ...
    ###########################################################################
    new1_turtle= rg.SimpleTurtle('classic')
    new1_turtle.pen = rg.Pen('brown', 5)
    new1_turtle.forward(150)
    new1_turtle.left(90)
    new1_turtle.forward(50)
    new1_turtle.backward(100)
...
def try_methods_and_functions():
    ...
    ###########################################################################
    new2_turtle= rg.SimpleTurtle('classic')
    new2_turtle.pen = rg.Pen('blue', 5)
    new2_turtle.backward(150)
    new2_turtle.speed=1
    draw_many_squares(new2_turtle, 2, 100, 30)

    new2_turtle.speed=5
    new2_turtle.pen = rg.Pen('red', 5)
    draw_many_squares(new2_turtle, 10, 50, 15)

    new2_turtle.speed = 100
    new2_turtle.pen = rg.Pen('red', 35)
    draw_many_squares(new2_turtle, 8, 300, 60)

    new3_turtle = rg.SimpleTurtle('turtle')
    new3_turtle.pen = rg.Pen('black', 3)

    new3_turtle.backward(200)

    new3_turtle.draw_circle(30)

    new3_turtle.draw_square(50)
# -----------------------------------------------------------------------------
